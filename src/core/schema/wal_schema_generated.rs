...
pub mod wal {
    ...
    impl Metadata {
        ...
        pub const ENUM_VALUES: &'static [Self] =
            &[Self::NONE, Self::EventMeta, Self::LogMeta, Self::TraceMeta];
        /// Returns the variant's name or "" if unknown.
        pub fn variant_name(self) -> Option<&'static str> {
            match self {
                Self::NONE => Some("NONE"),
    ...
    impl<'a> EventMeta<'a> {
        ...
        pub fn service_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(EventMeta::VT_SERVICE_ID, None)
            }
        }
    }
    ...
    impl<'a> LogMeta<'a> {
        ...
        >(
            ...
            if let Some(x) = args.flight_id {
                builder.add_flight_id(x);
            }
            builder.finish()
        }
        ...
        pub fn flight_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(LogMeta::VT_FLIGHT_ID, None)
            }
        }
        #[inline]
        pub fn arrow_buffer_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(LogMeta::VT_ARROW_BUFFER_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn service_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(LogMeta::VT_SERVICE_ID, None)
            }
        }
        #[inline]
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LogMetaBuilder<'a, 'b, A> {
        ...
        pub fn add_flight_id(&mut self, flight_id: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(LogMeta::VT_FLIGHT_ID, flight_id);
        }
        #[inline]
        pub fn add_arrow_buffer_id(&mut self, arrow_buffer_id: u64) {
            self.fbb_
                .push_slot::<u64>(LogMeta::VT_ARROW_BUFFER_ID, arrow_buffer_id, 0);
        }
        #[inline]
        pub fn add_service_id(&mut self, service_id: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(LogMeta::VT_SERVICE_ID, service_id);
        }
        #[inline]
        pub fn add_partition_fields(
            &mut self,
            partition_fields: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<&'b str>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                LogMeta::VT_PARTITION_FIELDS,
                partition_fields,
            );
        }
        #[inline]
    ...
    impl<'a> TraceMeta<'a> {
        ...
        >(
            ...
            if let Some(x) = args.tenant_id {
                builder.add_tenant_id(x);
            }
            if let Some(x) = args.service_id {
                builder.add_service_id(x);
            }
        ...
        pub fn service_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(TraceMeta::VT_SERVICE_ID, None)
            }
        }
        #[inline]
        pub fn tenant_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(TraceMeta::VT_TENANT_ID, None)
            }
        }
        #[inline]
        pub fn timestamp_unix_micros(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(TraceMeta::VT_TIMESTAMP_UNIX_MICROS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn partition_fields(
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>,
                >>(TraceMeta::VT_PARTITION_FIELDS, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TraceMetaBuilder<'a, 'b, A> {
        ...
        pub fn add_tenant_id(&mut self, tenant_id: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(TraceMeta::VT_TENANT_ID, tenant_id);
        }
        #[inline]
        pub fn add_timestamp_unix_micros(&mut self, timestamp_unix_micros: u64) {
            self.fbb_.push_slot::<u64>(
                TraceMeta::VT_TIMESTAMP_UNIX_MICROS,
                timestamp_unix_micros,
                0,
            );
        }
    ...
    impl<'a> FlatbufMeta<'a> {
        ...
        pub fn version(&self) -> u8 {
            ...
            unsafe {
                self._tab
                    .get::<u8>(FlatbufMeta::VT_VERSION, Some(1))
                    .unwrap()
            }
        }
        #[inline]
        ...
        pub fn timestamp_unix_micros(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(FlatbufMeta::VT_TIMESTAMP_UNIX_MICROS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn serialization(&self) -> Serialization {
            ...
            unsafe {
                self._tab
                    .get::<Serialization>(FlatbufMeta::VT_SERIALIZATION, Some(Serialization::Arrow))
                    .unwrap()
            }
        }
        #[inline]
        ...
        pub fn meta_type(&self) -> Metadata {
            ...
            unsafe {
                self._tab
                    .get::<Metadata>(FlatbufMeta::VT_META_TYPE, Some(Metadata::NONE))
                    .unwrap()
            }
        }
        #[inline]
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_union::<Metadata, _>(
                    ...
                    false,
                    |key, v, pos| match key {
                        Metadata::EventMeta => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<EventMeta>>(
                                "Metadata::EventMeta",
                                pos,
                            ),
                        Metadata::LogMeta => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<LogMeta>>(
                                "Metadata::LogMeta",
                                pos,
                            ),
                        Metadata::TraceMeta => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<TraceMeta>>(
                                "Metadata::TraceMeta",
                                pos,
                            ),
                        _ => Ok(()),
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FlatbufMetaBuilder<'a, 'b, A> {
        ...
        pub fn add_version(&mut self, version: u8) {
            self.fbb_
                .push_slot::<u8>(FlatbufMeta::VT_VERSION, version, 1);
        }
        #[inline]
        ...
        pub fn add_timestamp_unix_micros(&mut self, timestamp_unix_micros: u64) {
            self.fbb_.push_slot::<u64>(
                FlatbufMeta::VT_TIMESTAMP_UNIX_MICROS,
                timestamp_unix_micros,
                0,
            );
        }
        ...
        pub fn add_meta_type(&mut self, meta_type: Metadata) {
            self.fbb_
                .push_slot::<Metadata>(FlatbufMeta::VT_META_TYPE, meta_type, Metadata::NONE);
        }
        #[inline]
        pub fn add_meta(&mut self, meta: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(FlatbufMeta::VT_META, meta);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> FlatbufMetaBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            FlatbufMetaBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn size_prefixed_root_as_flatbuf_meta(
        buf: &[u8],
    ) -> Result<FlatbufMeta, flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_flatbuf_meta_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
        fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        root: flatbuffers::WIPOffset<FlatbufMeta<'a>>,
    ) {
